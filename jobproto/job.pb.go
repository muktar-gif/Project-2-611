...
func (x *TerminateMessage) GetTerminate() bool {
	if x != nil {
		return x.Terminate
	}
	return false
...
var file_jobproto_job_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e,
	...
	0x6d, 0x69, 0x6e, 0x61, 0x74, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x2e, 0x5a,
...
var file_jobproto_job_proto_goTypes = []interface{}{
	...
	(*TerminateMessage)(nil), // 2: jobservice.TerminateMessage
...
var file_jobproto_job_proto_depIdxs = []int32{
	...
	2, // 4: jobservice.JobService.PushResult:output_type -> jobservice.TerminateMessage
